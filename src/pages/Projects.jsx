    ...
    <section className="container mx-auto p-4 pt-16 text-white">
      ...
      <ul className="list-disc pl-6 space-y-4 text-lg">
        <li className="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-2 md:space-y-0">
          <strong className="text-blue-400">ProjectAlpha</strong>: A web app for university result analysis with dynamic charts and analytics.
          <Link
        ...
        <li className="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-2 md:space-y-0">
          <strong className="text-blue-400">MKT 25th Batch Results</strong>: A static webpage with preloaded data for result analysis with dynamic charts and analytics.
          <a
