...
// Keep CGPA/ranking values more precise without unnecessary trailing zeroes
export const CGPA_DECIMALS = 8;

export const roundToDecimalPlaces = (value, decimals = CGPA_DECIMALS) => {
